...
class LexiconBuilderTest(test_util.TensorFlowTestCase):
  ...
  def LoadMap(self, map_name):
    loaded_map = {}
    with open(os.path.join(FLAGS.test_tmpdir, map_name), 'r', encoding='utf-8') as f:
      for line in f:
